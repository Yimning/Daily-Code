...
*/
	...
	SYSLOG_DBG("NJRuiQuan modbus Cr protocol,Cr : read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG_HEX("NJRuiQuan modbus Cr data ",com_rbuf,size);	
	...
	acqdata_set_value(acq_data,"w20116",UNIT_MG_L,Cr,&arg_n);
	if(status == 0)
