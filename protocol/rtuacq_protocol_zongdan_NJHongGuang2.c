...
Description:protocol_ZONGDAN_NJHongGuang2
...
int protocol_ZONGDAN_NJHongGuang_info2(struct acquisition_data *acq_data)
{
	int status=0;
	char com_rbuf[2048]={0}; 
	char com_tbuf[8]={0};
	...
	LOG_WRITE_HEX(DEV_NAME(acq_data),1,"NJHongGuang TN INFO RECV3_2:",&com_rbuf[200],size-200);
