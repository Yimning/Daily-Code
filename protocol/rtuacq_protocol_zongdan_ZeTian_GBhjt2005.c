...
int protocol_ZONGDAN_ZeTian_GBhjt2005(struct acquisition_data *acq_data)
{
	...
	char flag=0;
	int ret=0;
	static char polcode[10]="065";
	char str[50];

	if(!acq_data) return -1; 

	size=getStrDataPack(DEV_NAME(acq_data), NULL, 0, com_rbuf, sizeof(com_rbuf), "ZeTian GBhjt2005 TN", 1);
	if((p=strstr(com_rbuf,"CN=2011"))!=NULL)
	{
		q=p;
		if(((p=strstr(p,"CP=&&"))==NULL) || (strstr(&p[5],"&&")==NULL))
		{
			size+=getStrDataPack(DEV_NAME(acq_data), NULL, 0, &com_rbuf[size], sizeof(com_rbuf)-size, "ZeTian GBhjt2005 TN again", 1);
			p=strstr(q,"CP=&&");
		}
...
int protocol_ZONGDAN_ZeTian_GBhjt2005_status(struct acquisition_data *acq_data)
{
	int status=0;
	float *pf;
	union uf  f;
	...
	if(!acq_data) return -1;
	SYSLOG_DBG("protocol_ZONGDAN_ZeTian_GBhjt2005_status\n");
	...
	size=getStrDataPack(DEV_NAME(acq_data), com_tbuf, size, com_rbuf, sizeof(com_rbuf), "ZeTian GBhjt2005 TN status", 1);
...
int protocol_ZONGDAN_ZeTian_GBhjt2005_info1(struct acquisition_data *acq_data)
{
	int status=0;
	float *pf;
	union uf  f;
	...
	if(!acq_data) return -1;
	SYSLOG_DBG("protocol_ZONGDAN_ZeTian_GBhjt2005_info1\n");
	...
	size=strlen(com_tbuf);
	size=getStrDataPack(DEV_NAME(acq_data), com_tbuf, size, com_rbuf, sizeof(com_rbuf), "ZeTian GBhjt2005 TN info1.1", 1);
	...
	size=strlen(com_tbuf);
	size=getStrDataPack(DEV_NAME(acq_data), com_tbuf, size, com_rbuf, sizeof(com_rbuf), "ZeTian GBhjt2005 TN info1.2", 1);
...
int protocol_ZONGDAN_ZeTian_GBhjt2005_info2(struct acquisition_data *acq_data)
{
	int status=0;
	float *pf;
	union uf  f;
	...
	if(!acq_data) return -1;
	SYSLOG_DBG("protocol_ZONGDAN_ZeTian_GBhjt2005_info2\n");
	...
	size=strlen(com_tbuf);
	size=getStrDataPack(DEV_NAME(acq_data), com_tbuf, size, com_rbuf, sizeof(com_rbuf), "ZeTian GBhjt2005 TN info2.1", 1);
	...
	size=strlen(com_tbuf);
	size=getStrDataPack(DEV_NAME(acq_data), com_tbuf, size, com_rbuf, sizeof(com_rbuf), "ZeTian GBhjt2005 TN info2.2", 1);
...
int protocol_ZONGDAN_ZeTian_GBhjt2005_info3(struct acquisition_data *acq_data)
{
	int status=0;
	float *pf;
	union uf  f;
	...
	if(!acq_data) return -1;
	SYSLOG_DBG("protocol_ZONGDAN_ZeTian_GBhjt2005_info3\n");
	...
	size=strlen(com_tbuf);
	size=getStrDataPack(DEV_NAME(acq_data), com_tbuf, size, com_rbuf, sizeof(com_rbuf), "ZeTian GBhjt2005 TN info3.1", 1);
	...
	size=strlen(com_tbuf);
	size=getStrDataPack(DEV_NAME(acq_data), com_tbuf, size, com_rbuf, sizeof(com_rbuf), "ZeTian GBhjt2005 TN info3.2", 1);
...
int protocol_ZONGDAN_ZeTian_GBhjt2005_info4(struct acquisition_data *acq_data)
{
	int status=0;
	float *pf;
	union uf  f;
	...
	if(!acq_data) return -1;
	SYSLOG_DBG("protocol_ZONGDAN_ZeTian_GBhjt2005_info4\n");
	...
	size=strlen(com_tbuf);
	size=getStrDataPack(DEV_NAME(acq_data), com_tbuf, size, com_rbuf, sizeof(com_rbuf), "ZeTian GBhjt2005 TN info4.1", 1);
	...
	size=strlen(com_tbuf);
	size=getStrDataPack(DEV_NAME(acq_data), com_tbuf, size, com_rbuf, sizeof(com_rbuf), "ZeTian GBhjt2005 TN info4.2", 1);
...
int protocol_ZONGDAN_ZeTian_GBhjt2005_info5(struct acquisition_data *acq_data)
{
	int status=0;
	float *pf;
	union uf  f;
	...
	if(!acq_data) return -1;
	SYSLOG_DBG("protocol_ZONGDAN_ZeTian_GBhjt2005_info5\n");
	...
	size=strlen(com_tbuf);
	size=getStrDataPack(DEV_NAME(acq_data), com_tbuf, size, com_rbuf, sizeof(com_rbuf), "ZeTian GBhjt2005 TN info5.1", 1);
