...
*/
	...
	SYSLOG_DBG("NJRuiQuan modbus Cu protocol,Cu : read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG_HEX("NJRuiQuan modbus Cu data ",com_rbuf,size);	
	...
	acqdata_set_value(acq_data,"w20122",UNIT_MG_L,Cu,&arg_n);
	if(status == 0)
