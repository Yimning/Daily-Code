...
{
#define POLCODE_NUM 29

	char *polcode[POLCODE_NUM]={
		"g29001","g28201","g28001","g20101","g18001",
		"g18101","g18401","e30101","e30001","e30102",
		"e30002","e30103","e30003","e30104","e30004",
		"e30105","e30005","e60201","e60202","e60203",
		"e60204","e60205","e70201","e70202","e70203",
		"e70204","e70205","e80201","e80202",
	};
	UNIT_DECLARATION unit[POLCODE_NUM]={
		...
		UNIT_KWH,		UNIT_KW,	UNIT_KWH,	UNIT_KW,	UNIT_KWH,
		UNIT_KW,		UNIT_KWH,	UNIT_A,		UNIT_A,		UNIT_A,
		UNIT_A,			UNIT_A,		UNIT_A,		UNIT_A,		UNIT_A,
		UNIT_A,			UNIT_A,		UNIT_A,		UNIT_A,
	};
	...
	LOG_WRITE_HEX(DEV_NAME(acq_data),0,"GZLiuEN_DongGuang3 voc SEND:",com_tbuf,size);
	size=write_device(DEV_NAME(acq_data),com_tbuf,size);
	sleep(1);

	memset(com_rbuf,0,sizeof(com_rbuf));
	size=read_device(DEV_NAME(acq_data),com_rbuf,sizeof(com_rbuf)-1);
	SYSLOG_DBG("GZLiuEN_DongGuang3 voc protocol,voc : read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG_HEX("GZLiuEN_DongGuang3 voc data",com_rbuf,size);
	LOG_WRITE_HEX(DEV_NAME(acq_data),1,"GZLiuEN_DongGuang3 voc RECV:",com_rbuf,size);
