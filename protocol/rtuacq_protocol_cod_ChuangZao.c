...
int protocol_COD_ChuangZao(struct acquisition_data *acq_data)
{
/*
	TX: 01 03 00 00 00 08 C4 0B
	RX: 01 03 04 42 73 32 80 0B 50

	datatime= 
	cod = 42 73 32 80 = 60.79 mg/L
*/
	...
	SYSLOG_DBG("Chuangzao COD protocol,COD : read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG_HEX("Chuangzao COD data",com_rbuf,size);
