...
*/
	...
	SYSLOG_DBG("NJRuiQuan modbus Ni protocol,Ni : read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG_HEX("NJRuiQuan modbus Ni data ",com_rbuf,size);	
	...
	acqdata_set_value(acq_data,"w20121",UNIT_MG_L,Ni,&arg_n);
	if(status == 0)
