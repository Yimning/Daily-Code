...
*/
	...
	SYSLOG_DBG("NJRuiQuan modbus Pb protocol,Pb : read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG_HEX("NJRuiQuan modbus Pb data ",com_rbuf,size);	
	...
	acqdata_set_value(acq_data,"w20120",UNIT_UG_L,Pb,&arg_n);
	if(status == 0)
