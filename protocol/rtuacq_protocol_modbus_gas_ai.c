...
#define MODBUS_POLCODE_NUM 19
   char *polcodestr[MODBUS_POLCODE_NUM]={"a21003","a21004","a21005","a21005z",
											"a21026","a21026z","a21002","a21002z",
											"a34013","a34013z", "a01011","a19001",
											"a01012","a01013","a00000","a00000z",
											"a01014","a21024","a21024z","a05001"};
   UNIT_DECLARATION unitstr[MODBUS_POLCODE_NUM]={UNIT_MG_M3,UNIT_MG_M3,UNIT_MG_M3,UNIT_MG_M3,
													UNIT_MG_M3,UNIT_MG_M3,UNIT_MG_M3,UNIT_MG_M3,
													UNIT_MG_M3,UNIT_MG_M3,UNIT_M_S,UNIT_PECENT,
													UNIT_0C,UNIT_KPA,UNIT_M3_H,UNIT_M3_H,
													UNIT_PECENT,UNIT_MG_M3,UNIT_MG_M3,UNIT_MG_M3};
	    ...
	    for(i=0;i<MODBUS_POLCODE_NUM;i++)
	    {
		   ...
		   if(mpolcodearg_temp)
		   {
	           ...
	           ret=modbus_get_valf(com_rbuf,size,mpolcodearg_temp->regaddr,mpolcodearg_temp->datatype,&valf);
			    SYSLOG_DBG("modbus protocol modbus_get_valf %s ,%f,%d,%d,%f,%f,%f,%f,ret=%d\n",polcodestr[i],valf,
