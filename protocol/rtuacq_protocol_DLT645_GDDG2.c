...
{
	#define DLT645_GDDG2_NUM 2
	const char * const polcode[DLT645_GDDG2_NUM] = {"ea2002","ea1902"};
	
	const int const DI[DLT645_GDDG2_NUM] = {0x00010000,0x02030000};
	
	const float const data_format[DLT645_GDDG2_NUM] = {100,10000};
	
	const UNIT_DECLARATION const units[DLT645_GDDG2_NUM]={UNIT_KWH,UNIT_KW};
	
	char addr[6]={0x45,0x98,0x00,0x11,0x06,0x19};//{0x54,0x09,0x15,0x80,0x10,0x91};
