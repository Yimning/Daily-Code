...
#define CEMSPOL_NUM 10

	char polcodestr[][20]={
		"a24088","a24087","a05002", "a01012","a01014",
		"a01013","a01011","a19001","a24088z","a00000"
	};

	UNIT_DECLARATION unitstr[CEMSPOL_NUM]={
		UNIT_MG_M3,UNIT_MG_M3,UNIT_MG_M3,UNIT_0C,UNIT_PECENT,
		UNIT_PA,UNIT_M_S,UNIT_PECENT,UNIT_MG_M3,UNIT_M3_S
	};
	...
	SYSLOG_DBG("protocol_ZeTian_GBhjt2005:size=%d,%s,%s\n",CEMSPOL_NUM,polcodestr[0],cemspol[0]);
