...
*/
	...
	SYSLOG_DBG("NJRuiQuan modbus Mn protocol,Mn : read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG_HEX("NJRuiQuan modbus Mn data ",com_rbuf,size);	
	...
	acqdata_set_value(acq_data,"w20124",UNIT_MG_L,Mn,&arg_n);
	if(status == 0)
