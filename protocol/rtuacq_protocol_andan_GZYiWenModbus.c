...
int protocol_ANDAN_GZYiWenModbus(struct acquisition_data *acq_data)
{
	...
	LOG_WRITE_HEX(DEV_NAME(acq_data),0,"GZYiWen andan SEND:",com_tbuf,size);
	...
	SYSLOG_DBG_HEX("GZYiWen andan data",com_rbuf,size);
	LOG_WRITE_HEX(DEV_NAME(acq_data),1,"GZYiWen andan RECV:",com_rbuf,size);
