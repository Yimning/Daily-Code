...
int protocol_CEMS_AHWanYi_SG1000_HeBei(struct acquisition_data *acq_data)
{
   ...
   rdtuinfo=get_parent_rdtu_info(acq_data);
	...
	LOG_WRITE_STR(DEV_NAME(acq_data),0,"AHWanYi_SG1000 HeBei CEMS SEND1:",com_tbuf,size);
	size=write_device(DEV_NAME(acq_data),com_tbuf,size);
	sleep(1);
	memset(com_rbuf,0,sizeof(com_rbuf));
	size=read_device(DEV_NAME(acq_data),com_rbuf,sizeof(com_rbuf)-1);
	SYSLOG_DBG("AHWanYi_SG1000 HeBei CEMS protocol,CEMS 1: read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG("AHWanYi_SG1000 HeBei CEMS data : %s",com_rbuf);
	LOG_WRITE_STR(DEV_NAME(acq_data),1,"AHWanYi_SG1000 HeBei CEMS RECV1:",com_rbuf,size);
	...
	LOG_WRITE_STR(DEV_NAME(acq_data),0,"AHWanYi_SG1000 HeBei CEMS SEND2:",com_tbuf,size);
	size=write_device(DEV_NAME(acq_data),com_tbuf,size);
	sleep(1);
	memset(com_rbuf,0,sizeof(com_rbuf));
	size=read_device(DEV_NAME(acq_data),com_rbuf,sizeof(com_rbuf)-1);
	SYSLOG_DBG("AHWanYi_SG1000 HeBei CEMS protocol,CEMS 2: read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG("AHWanYi_SG1000 HeBei CEMS data : %s",com_rbuf);
	LOG_WRITE_STR(DEV_NAME(acq_data),1,"AHWanYi_SG1000 HeBei CEMS RECV2:",com_rbuf,size);
	...
	LOG_WRITE_STR(DEV_NAME(acq_data),0,"AHWanYi_SG1000 HeBei CEMS SEND3:",com_tbuf,size);
	size=write_device(DEV_NAME(acq_data),com_tbuf,size);
	sleep(1);
	memset(com_rbuf,0,sizeof(com_rbuf));
	size=read_device(DEV_NAME(acq_data),com_rbuf,sizeof(com_rbuf)-1);
	SYSLOG_DBG("AHWanYi_SG1000 HeBei CEMS protocol,CEMS 3: read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG("AHWanYi_SG1000 HeBei CEMS data : %s",com_rbuf);
	LOG_WRITE_STR(DEV_NAME(acq_data),1,"AHWanYi_SG1000 HeBei CEMS RECV3:",com_rbuf,size);
	...
	devaddr=0x60;
	memset(com_tbuf,0,sizeof(com_tbuf));
	size=modbus_ascii_pack(com_tbuf,devaddr,0x04,0x00,0x02);
	LOG_WRITE_STR(DEV_NAME(acq_data),0,"AHWanYi_SG1000 HeBei CEMS SEND4:",com_tbuf,size);
	size=write_device(DEV_NAME(acq_data),com_tbuf,size);
	sleep(1);
	memset(com_rbuf,0,sizeof(com_rbuf));
	size=read_device(DEV_NAME(acq_data),com_rbuf,sizeof(com_rbuf)-1);
	SYSLOG_DBG("AHWanYi_SG1000 HeBei CEMS protocol,CEMS 4: read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG("AHWanYi_SG1000 HeBei CEMS data : %s",com_rbuf);
	LOG_WRITE_STR(DEV_NAME(acq_data),1,"AHWanYi_SG1000 HeBei CEMS RECV4:",com_rbuf,size);
	...
	LOG_WRITE_STR(DEV_NAME(acq_data),0,"AHWanYi_SG1000 HeBei CEMS SEND5:",com_tbuf,size);
	size=write_device(DEV_NAME(acq_data),com_tbuf,size);
	sleep(2);
	memset(com_rbuf,0,sizeof(com_rbuf));
	size=read_device(DEV_NAME(acq_data),com_rbuf,sizeof(com_rbuf)-1);
	SYSLOG_DBG("AHWanYi_SG1000 HeBei CEMS protocol,CEMS 5: read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG("AHWanYi_SG1000 HeBei CEMS data : %s",com_rbuf);
	LOG_WRITE_STR(DEV_NAME(acq_data),1,"AHWanYi_SG1000 HeBei CEMS RECV5:",com_rbuf,size);
	if(size>=13 && modbus_ascii_pack_check(com_rbuf, devaddr, 0x02))
	{
		...
		if(p[3]==0)
		{
			...
			LOG_WRITE_STR(DEV_NAME(acq_data),0,"AHWanYi_SG1000 HeBei CEMS SEND6:",com_tbuf,size);
			size=write_device(DEV_NAME(acq_data),com_tbuf,size);
			sleep(1);
			memset(com_rbuf,0,sizeof(com_rbuf));
			size=read_device(DEV_NAME(acq_data),com_rbuf,sizeof(com_rbuf)-1);
			SYSLOG_DBG("AHWanYi_SG1000 HeBei CEMS protocol,CEMS 6: read device %s , size=%d\n",DEV_NAME(acq_data),size);
			SYSLOG_DBG("AHWanYi_SG1000 HeBei CEMS data : %s",com_rbuf);
			LOG_WRITE_STR(DEV_NAME(acq_data),1,"AHWanYi_SG1000 HeBei CEMS RECV6:",com_rbuf,size);
...
#if 1 //added by miles zhang 20210607 for pass one pack of O2 > 19
        //if(o2>19 && O2_cnt==0)
        if(o2>19 && O2_cnt<20)
        {
            status=1;
...
int protocol_CEMS_AHWanYi_SG1000_HeBei_SO2_info(struct acquisition_data *acq_data)
{
	int status=0;
	char com_rbuf[2048]={0}; 
	char com_tbuf[8]={0};
	...
	if(!acq_data) return -1;
	SYSLOG_DBG("protocol_CEMS_AHWanYi_SG1000_HeBei_SO2_info\n");
	...
	LOG_WRITE_STR(DEV_NAME(acq_data),0,"AHWanYi_SG1000 SO2 INFO SEND1:",com_tbuf,size);
	size=write_device(DEV_NAME(acq_data),com_tbuf,size);
	sleep(1);
	memset(com_rbuf,0,sizeof(com_rbuf));
	size=read_device(DEV_NAME(acq_data),com_rbuf,sizeof(com_rbuf)-1);
	SYSLOG_DBG("AHWanYi_SG1000 SO2 protocol,INFO 1: read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG("AHWanYi_SG1000 SO2 data : %s",com_rbuf);
	LOG_WRITE_STR(DEV_NAME(acq_data),1,"AHWanYi_SG1000 SO2 INFO RECV1:",com_rbuf,size);
	...
	LOG_WRITE_STR(DEV_NAME(acq_data),0,"AHWanYi_SG1000 SO2 INFO SEND2:",com_tbuf,size);
	size=write_device(DEV_NAME(acq_data),com_tbuf,size);
	sleep(1);
	memset(com_rbuf,0,sizeof(com_rbuf));
	size=read_device(DEV_NAME(acq_data),com_rbuf,sizeof(com_rbuf)-1);
	SYSLOG_DBG("AHWanYi_SG1000 SO2 protocol,INFO 2: read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG("AHWanYi_SG1000 SO2 data : %s",com_rbuf);
	LOG_WRITE_STR(DEV_NAME(acq_data),1,"AHWanYi_SG1000 SO2 INFO RECV2:",com_rbuf,size);
	...
	LOG_WRITE_STR(DEV_NAME(acq_data),0,"AHWanYi_SG1000 SO2 INFO SEND3:",com_tbuf,size);
	size=write_device(DEV_NAME(acq_data),com_tbuf,size);
	sleep(1);
	memset(com_rbuf,0,sizeof(com_rbuf));
	size=read_device(DEV_NAME(acq_data),com_rbuf,sizeof(com_rbuf)-1);
	SYSLOG_DBG("AHWanYi_SG1000 SO2 protocol,INFO 3: read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG("AHWanYi_SG1000 SO2 data : %s",com_rbuf);
	LOG_WRITE_STR(DEV_NAME(acq_data),1,"AHWanYi_SG1000 SO2 INFO RECV3:",com_rbuf,size);
	...
	LOG_WRITE_STR(DEV_NAME(acq_data),0,"AHWanYi_SG1000 STATUS SEND:",com_tbuf,size);
	size=write_device(DEV_NAME(acq_data),com_tbuf,size);
	sleep(1);
	memset(com_rbuf,0,sizeof(com_rbuf));
	size=read_device(DEV_NAME(acq_data),com_rbuf,sizeof(com_rbuf)-1);
	SYSLOG_DBG("AHWanYi_SG1000 STATUS protocol,STATUS : read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG("AHWanYi_SG1000 STATUS data : %s",com_rbuf);
	LOG_WRITE_STR(DEV_NAME(acq_data),1,"AHWanYi_SG1000 STATUS RECV:",com_rbuf,size);
	if(size>=15 && modbus_ascii_pack_check(com_rbuf, devaddr, 0x04))
	{
		memset(p,0,sizeof(p));
		modbus_ascii_pack_to_hex_pack(com_rbuf,size,p);
...
int protocol_CEMS_AHWanYi_SG1000_HeBei_NOx_info(struct acquisition_data *acq_data)
{
	int status=0;
	char com_rbuf[2048]={0}; 
	char com_tbuf[8]={0};
	...
	if(!acq_data) return -1;
	SYSLOG_DBG("protocol_CEMS_AHWanYi_SG1000_HeBei_NOx_info\n");
	...
	LOG_WRITE_STR(DEV_NAME(acq_data),0,"AHWanYi_SG1000 NOx INFO SEND1:",com_tbuf,size);
	size=write_device(DEV_NAME(acq_data),com_tbuf,size);
	sleep(1);
	memset(com_rbuf,0,sizeof(com_rbuf));
	size=read_device(DEV_NAME(acq_data),com_rbuf,sizeof(com_rbuf)-1);
	SYSLOG_DBG("AHWanYi_SG1000 NOx protocol,INFO 1: read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG("AHWanYi_SG1000 NOx data : %s",com_rbuf);
	LOG_WRITE_STR(DEV_NAME(acq_data),1,"AHWanYi_SG1000 NOx INFO RECV1:",com_rbuf,size);
	...
	LOG_WRITE_STR(DEV_NAME(acq_data),0,"AHWanYi_SG1000 NOx INFO SEND2:",com_tbuf,size);
	size=write_device(DEV_NAME(acq_data),com_tbuf,size);
	sleep(1);
	memset(com_rbuf,0,sizeof(com_rbuf));
	size=read_device(DEV_NAME(acq_data),com_rbuf,sizeof(com_rbuf)-1);
	SYSLOG_DBG("AHWanYi_SG1000 NOx protocol,INFO 2: read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG("AHWanYi_SG1000 NOx data : %s",com_rbuf);
	LOG_WRITE_STR(DEV_NAME(acq_data),1,"AHWanYi_SG1000 NOx INFO RECV2:",com_rbuf,size);
	...
	LOG_WRITE_STR(DEV_NAME(acq_data),0,"AHWanYi_SG1000 NOx INFO SEND3:",com_tbuf,size);
	size=write_device(DEV_NAME(acq_data),com_tbuf,size);
	sleep(1);
	memset(com_rbuf,0,sizeof(com_rbuf));
	size=read_device(DEV_NAME(acq_data),com_rbuf,sizeof(com_rbuf)-1);
	SYSLOG_DBG("AHWanYi_SG1000 NOx protocol,INFO 3: read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG("AHWanYi_SG1000 NOx data : %s",com_rbuf);
	LOG_WRITE_STR(DEV_NAME(acq_data),1,"AHWanYi_SG1000 NOx INFO RECV3:",com_rbuf,size);
...
int protocol_CEMS_AHWanYi_SG1000_HeBei_O2_info(struct acquisition_data *acq_data)
{
	int status=0;
	char com_rbuf[2048]={0}; 
	char com_tbuf[8]={0};
	...
	if(!acq_data) return -1;
	SYSLOG_DBG("protocol_CEMS_AHWanYi_SG1000_HeBei_O2_info\n");
	...
	LOG_WRITE_STR(DEV_NAME(acq_data),0,"AHWanYi_SG1000 O2 INFO SEND1:",com_tbuf,size);
	size=write_device(DEV_NAME(acq_data),com_tbuf,size);
	sleep(1);
	memset(com_rbuf,0,sizeof(com_rbuf));
	size=read_device(DEV_NAME(acq_data),com_rbuf,sizeof(com_rbuf)-1);
	SYSLOG_DBG("AHWanYi_SG1000 O2 protocol,INFO 1: read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG("AHWanYi_SG1000 O2 data : %s",com_rbuf);
	LOG_WRITE_STR(DEV_NAME(acq_data),1,"AHWanYi_SG1000 O2 INFO RECV1:",com_rbuf,size);
	if(size>=43 && modbus_ascii_pack_check(com_rbuf, devaddr, 0x04))
	{
		memset(p,0,sizeof(p));
		modbus_ascii_pack_to_hex_pack(com_rbuf,size,p);
	...
	LOG_WRITE_STR(DEV_NAME(acq_data),0,"AHWanYi_SG1000 O2 INFO SEND2:",com_tbuf,size);
	size=write_device(DEV_NAME(acq_data),com_tbuf,size);
	sleep(1);
	memset(com_rbuf,0,sizeof(com_rbuf));
	size=read_device(DEV_NAME(acq_data),com_rbuf,sizeof(com_rbuf)-1);
	SYSLOG_DBG("AHWanYi_SG1000 O2 protocol,INFO 2: read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG("AHWanYi_SG1000 O2 data : %s",com_rbuf);
	LOG_WRITE_STR(DEV_NAME(acq_data),1,"AHWanYi_SG1000 O2 INFO RECV2:",com_rbuf,size);
	...
	LOG_WRITE_STR(DEV_NAME(acq_data),0,"AHWanYi_SG1000 O2 INFO SEND3:",com_tbuf,size);
	size=write_device(DEV_NAME(acq_data),com_tbuf,size);
	sleep(1);
	memset(com_rbuf,0,sizeof(com_rbuf));
	size=read_device(DEV_NAME(acq_data),com_rbuf,sizeof(com_rbuf)-1);
	SYSLOG_DBG("AHWanYi_SG1000 O2 protocol,INFO 3: read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG("AHWanYi_SG1000 O2 data : %s",com_rbuf);
	LOG_WRITE_STR(DEV_NAME(acq_data),1,"AHWanYi_SG1000 O2 INFO RECV3:",com_rbuf,size);
	if(size>=59 && modbus_ascii_pack_check(com_rbuf, devaddr, 0x03))
	{
		memset(p,0,sizeof(p));
		modbus_ascii_pack_to_hex_pack(com_rbuf,size,p);
...
int protocol_CEMS_AHWanYi_SG1000_HeBei_TSP_info(struct acquisition_data *acq_data)
{
	int status=0;
	char com_rbuf[2048]={0}; 
	char com_tbuf[8]={0};
	...
	LOG_WRITE_STR(DEV_NAME(acq_data),0,"AHWanYi_SG1000 TSP STATUS SEND1:",com_tbuf,size);
	size=write_device(DEV_NAME(acq_data),com_tbuf,size);
	sleep(1);
	memset(com_rbuf,0,sizeof(com_rbuf));
	size=read_device(DEV_NAME(acq_data),com_rbuf,sizeof(com_rbuf)-1);
	SYSLOG_DBG("AHWanYi_SG1000 TSP protocol,STATUS 1: read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG("AHWanYi_SG1000 TSP data : %s",com_rbuf);
	LOG_WRITE_STR(DEV_NAME(acq_data),1,"AHWanYi_SG1000 TSP STATUS RECV1:",com_rbuf,size);
	...
	LOG_WRITE_STR(DEV_NAME(acq_data),0,"AHWanYi_SG1000 TSP STATUS SEND2:",com_tbuf,size);
	size=write_device(DEV_NAME(acq_data),com_tbuf,size);
	sleep(1);
	memset(com_rbuf,0,sizeof(com_rbuf));
	size=read_device(DEV_NAME(acq_data),com_rbuf,sizeof(com_rbuf)-1);
	SYSLOG_DBG("AHWanYi_SG1000 TSP protocol,STATUS 2: read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG("AHWanYi_SG1000 TSP data : %s",com_rbuf);
	LOG_WRITE_STR(DEV_NAME(acq_data),1,"AHWanYi_SG1000 TSP STATUS RECV2:",com_rbuf,size);
	if(size>=13 && modbus_ascii_pack_check(com_rbuf, devaddr, 0x04))
	{
		memset(p,0,sizeof(p));
		modbus_ascii_pack_to_hex_pack(com_rbuf,size,p);
	...
	LOG_WRITE_STR(DEV_NAME(acq_data),0,"AHWanYi_SG1000 TSP INFO SEND:",com_tbuf,size);
	size=write_device(DEV_NAME(acq_data),com_tbuf,size);
	sleep(1);
	memset(com_rbuf,0,sizeof(com_rbuf));
	size=read_device(DEV_NAME(acq_data),com_rbuf,sizeof(com_rbuf)-1);
	SYSLOG_DBG("AHWanYi_SG1000 TSP protocol,INFO: read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG("AHWanYi_SG1000 TSP data : %s",com_rbuf);
	LOG_WRITE_STR(DEV_NAME(acq_data),1,"AHWanYi_SG1000 TSP INFO RECV:",com_rbuf,size);
