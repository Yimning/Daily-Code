...
int protocol_ANDAN_ChuangZao(struct acquisition_data *acq_data)
{
/*
...
*/
	...
	SYSLOG_DBG("ChuangZao andan protocol,andan : read device %s , size=%d\n",DEV_NAME(acq_data),size);
	SYSLOG_DBG_HEX("ChuangZao andan data",com_rbuf,size);
