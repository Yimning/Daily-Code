...
#define Fire_POLCODE_NUM   11
   char polcodestr[Fire_POLCODE_NUM][20]={"SCXBH",
   ...
   char cemspol[][20]={"SCXBH",
	...
	if(!acq_data) return -1;
	   ...
	   SYSLOG_DBG("protocol_CEMS_GBhjt2017:size=%d,%s,%s\n",Fire_POLCODE_NUM,polcodestr[0],cemspol[0]);

        ret=protocol_CEMS_GBhjt212_once_flag(acq_data,Fire_POLCODE_NUM,polcodestr,unitstr,cemspol);	
