...
#define CEMSPOL_NUM 11
	...
	char *polcodestr[CEMSPOL_NUM]={
		"a05002","a24087","a24088","a01016",
		"a01017","a01011","a01012","a00000",
		"a01013","a01014","a00000z"
	};

	UNIT_DECLARATION unitstr[CEMSPOL_NUM]={
		UNIT_MG_M3, UNIT_MG_M3,	 UNIT_MG_M3, UNIT_M2,
		UNIT_KPA,	UNIT_M_S,	 UNIT_0C,	 UNIT_M3_H,
		UNIT_PA,		UNIT_PECENT, UNIT_M3_H
	};
	...
	{
		sscanf(com_rbuf,"#1,%f,%f,%f,%f,%f,%f,%f,Z,%f,%f,%f,%f,%c,",
			&valf[0],&valf[1],&valf[2],&valf[3],
			&valf[4],&valf[5],&valf[6],&valf[7],
			&valf[8],&valf[9],&valf[10],&flag);
